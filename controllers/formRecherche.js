...
async function post(req, res, next) {
  ...
  try{  
    dataFormRecherche = await formRecherche.insertFormRecherche(dataFormRecherche);
...
function getDataFormRecherche(req) {  
  const dataFormRecherche = {
    ...
    publication_resultat_forme : req.body.publication_resultat_forme == null ? "" : req.body.publication_resultat_forme, 
