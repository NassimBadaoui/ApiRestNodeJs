...
const INSERT_SIA_FORM_DIMA =
  "INSERT INTO SIA_FORM_DIMA\n"+
  ...
  "IDENTIFICATION_FONCTION_CADRE_GESTIONNAIRE, IDENTIFICATION_FONCTION_DIRECTEUR, IDENTIFICATION_FONCTION_AUTRE, SERVICE_RATTACHEMENT,\n"+
  "COORDONNEES, MAIL, TELEPHONE, FINALITE_RECHERCHE, REFERENT_MEDICAL, DEMANDE_TRAVAIL_ACADEMIQUE, DEMANDE_RECHERCHE, DEMANDE_SUIVI_ACTIVITE_EPRD, DEMANDE_CONTROLE_QUALITE,\n"+
...
async function insertFormDima(data) {
  const dataFormDima = Object.assign({}, data); 
  const result = await database.simpleDimExecute(INSERT_SIA_FORM_DIMA, dataFormDima);
  //conDesc.conId = result.outBinds.conId[0];
  return dataFormDima;
}

module.exports.insertFormDima = insertFormDima;
